...
//    }
    ...
    public static String generateBip39() {
        byte[] initialEntropy = new byte[16];
        secureRandom.nextBytes(initialEntropy);
        String mnemonic = MnemonicUtils.generateMnemonic(initialEntropy);
        return mnemonic;
    ...
    public static String[] sha256toOsnPrivateKey(String mnemonic, String password) {
        byte[] seed = generateSeed(mnemonic);
        return ChatManager.Instance().createOsnIdFromMnemonic(seed, password);
