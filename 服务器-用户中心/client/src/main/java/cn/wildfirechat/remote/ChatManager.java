...
public class ChatManager {
    ...
    private List<OnLitappInfoUpdateListener> litappInfoUpdateListeners = new ArrayList<>();
    private List<OnLitappInfoResultListener> litappInfoResultListeners = new ArrayList<>();
    ...
    /**
     * 当有自己的用户账号体系，不想使用IM提供的用户信息托管服务时，调用此方法设置用户信息源
     *
    ...
    private void onRecallMessage(final long messageUid) {
       ...
       /* Message message = getMessageByUid(messageUid);
        ...
        try {
            Message recallMsg = mClient.getMessage(messageUid);
            mainHandler.post(new Runnable() {
                @Override
                public void run() {
    ...
    public void setRole(String key,String value){
        ...
        try {
            mClient.setRole(key,value,null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    private void onLitappInfoUpdated(List<LitappInfo> litappInfos) {
        if (litappInfos == null || litappInfos.isEmpty()) {
            return;
        }
        mainHandler.post(() -> {
            for (OnLitappInfoUpdateListener listener : litappInfoUpdateListeners) {
                listener.onLitappInfoUpdate(litappInfos);
            }
        });
    }
    private void onLitappInfoResult(List<LitappInfo> litappInfos) {
        if (litappInfos == null || litappInfos.isEmpty()) {
            return;
        }
        mainHandler.post(() -> {
            for (OnLitappInfoResultListener listener : litappInfoResultListeners) {
    ...
    public void addLitappInfoUpdateListener(OnLitappInfoUpdateListener listener) {
        if (listener == null) {
            return;
        }
        litappInfoUpdateListeners.add(listener);
    }
    public void removeLitappInfoUpdateListener(OnLitappInfoUpdateListener listener) {
        litappInfoUpdateListeners.remove(listener);
    }

    public void addLitappInfoResultListener(OnLitappInfoResultListener listener) {
        if (listener == null) {
            return;
        }
        litappInfoResultListeners.add(listener);
    }
    public void removeLitappInfoResultListener(OnLitappInfoResultListener listener) {
        litappInfoResultListeners.remove(listener);
    }
    ...
    /**
     * 获取clientId, IM用clientId唯一表示用户设备
     */
     ...
     * 创建频道
     *
     * @param channelId       频道id，如果传null，会自动生成id；否则，使用用户提供的id，需要保证此id的唯一性
...
//            }
    ...
    public String[] createOsnIdFromMnemonic(byte[] seed, String password){
        if (mClient != null) {
            try {
                String b64 = java.util.Base64.getEncoder().encodeToString(seed);
                return mClient.createOsnIdFromMnemonic(b64, password);
            } catch (RemoteException e) {
                e.printStackTrace();
            }
        }
    ...
    public void setVoiceBaseUrl(String voiceBaseUrl){
        try {
            ...
            mClient.setVoiceBaseUrl(voiceBaseUrl);
        }catch (Exception e){
    ...
    public String getVoiceBaseUrl(){
        try {
            ...
            return mClient.getVoiceBaseUrl();
        }catch (Exception e){
    ...
    public void setVoiceHostUrl(String voiceHostUrl){
        try {
            ...
            mClient.setVoiceHostUrl(voiceHostUrl);
        }catch (Exception e){
    ...
    public String getVoiceHostUrl(){
        try {
            ...
            return mClient.getVoiceHostUrl();
        }catch (Exception e){
    ...
    public String getShadowKeyPubId(String decPwd) {
        try {
            ...
            return mClient.getShadowKeyPubId(decPwd);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return "";
    ...
    public String signByShadowKey(String hash, String decPwd) {
        try {
            ...
            return mClient.signByShadowKey(hash, decPwd);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return "";
    ...
    public void simpleLogin(String serviceID, String url, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.simpleLogin(serviceID, url, new IGeneralCallback2.Stub() {
                    @Override
    ...
    public void allowGroupAddFriend(String value, String groupId, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.allowGroupAddFriend(value, groupId, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    //转发
    public void isGroupForward(String value, String groupId, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.isGroupForward(value, groupId, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    //复制
    public void isGroupCopy(String value, String groupId, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.isGroupCopy(value, groupId, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    //清空
    public void getClearChats(String value, String groupId, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.isClearChats(value, groupId, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    public void deleteTimeMessage(String time,String target, final GeneralCallback callback) {
        try {
            mClient.deleteTimeMessage(time, target, new IGeneralCallback() {
                @Override
                public void onSuccess() throws RemoteException {
    ...
    //置顶消息
    public void topMessage(String time,String value, String groupId, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.topMessage(time,value, groupId, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    public void deleteTopMessage(List<String> time, String groupId, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.deleteTopMessage(time, groupId, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    public void upAttribute(String key,String value, String groupId, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.upAttribute(key,value, groupId, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    public void upDescribes(String key,String value, String user, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.upDescribes(key,value, user, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    public void upDescribe(String key,String value, String group, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.upDescribe(key,value, group, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        System.out.println("[ChatManager] UpDescribe success." + data);
                        callback.onSuccess(data);
                    }
    ...
    public void upPrivateInfo(String key,String value, String group, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.upPrivateInfo(key,value, group, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        System.out.println("[ChatManager] upPrivateInfo success." + data);
                        callback.onSuccess(data);
                    }
    ...
    public void removeDescribes(String key, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.removeDescribes(key, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    public void ltbLogin(LitappInfo litappInfo, String url, GeneralCallback2 callback){
        if (mClient != null) {
            try {
                mClient.litappLogin(litappInfo, url, new IGeneralCallback2.Stub() {
                    @Override
                    public void onSuccess(String data) throws RemoteException {
                        callback.onSuccess(data);
                    }
    ...
    public void register(String userName, String password, String serviceID, GeneralCallback callback){
        if (TextUtils.isEmpty(userName) || TextUtils.isEmpty(password)) {
            throw new IllegalArgumentException("userId and token must be empty!");
        }
        if (mClient != null) {
            try {
                mClient.register(userName, password, serviceID, new IGeneralCallback.Stub() {
                    @Override
                    public void onSuccess() throws RemoteException {
                        callback.onSuccess();
                    }
...
//        this.token = token;
        ...
        if (mClient != null) {
            try {
                ...
                boolean result = mClient.connect(userId, token);
                if(result) {
                    UserInfo userInfo = mClient.getUserInfo(null, null, true);
                    SharedPreferences sp = gContext.getSharedPreferences("wildfirechat.config", Context.MODE_PRIVATE);
                    sp.edit()
                            .putString("userId", userInfo.uid)
    ...
    public boolean connect(String userId, String token, String password2) {
        if (TextUtils.isEmpty(userId) || TextUtils.isEmpty(token) || TextUtils.isEmpty(SERVER_HOST)) {
            throw new IllegalArgumentException("userId, token and im_server_host must not be empty!");
        }
...
//        this.token = token;
        ...
        if (mClient != null) {
            try {
                boolean result = mClient.connect2(userId, token, password2);
                if(result) {
                    UserInfo userInfo = mClient.getUserInfo(null, null, true);
                    SharedPreferences sp = gContext.getSharedPreferences("wildfirechat.config", Context.MODE_PRIVATE);
                    sp.edit()
    ...
    public void sendDynamic(String json, GeneralCallback2 callback){
        if (!checkRemoteService()) {
            if (callback != null) {
                callback.onFail(ErrorCode.SERVICE_DIED);
            }
        ...
        try {
            mClient.dynamic(json, new IGeneralCallback2.Stub() {
                @Override
    ...
    public void orderPay(String info, String code, GeneralCallback2 callback){
        if (!checkRemoteService()) {
            if (callback != null) {
                callback.onFail(ErrorCode.SERVICE_DIED);
            }
        ...
        try {
            mClient.orderPay(info, code, new IGeneralCallback2.Stub() {
                @Override
                public void onSuccess(String success) throws RemoteException {
                    callback.onSuccess(success);
                }
    ...
    public RedPacketInfo getRedPacket(String packetID){
        ...
        try {
            return mClient.getRedPacket(packetID);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return null;
    }
    public void getOwnerSign(String groupID, GeneralCallback2 callback){
        if (!checkRemoteService()) {
            return;
        }
        try {
            mClient.getOwnerSign(groupID, new IGeneralCallback2.Stub() {
                @Override
                public void onSuccess(String success) throws RemoteException {
                    callback.onSuccess(success);
                }
    ...
    public void getGroupSign(String groupID, String data, GeneralCallback2 callback){
        if (!checkRemoteService()) {
            return;
        }
        try {
            mClient.getGroupSign(groupID, data, new IGeneralCallback2.Stub() {
                @Override
                public void onSuccess(String success) throws RemoteException {
                    callback.onSuccess(success);
                }
    ...
    public void setGroupOwner(String groupID, String owner, GeneralCallback2 callback){
        if (!checkRemoteService()) {
            return;
        }
        try {
            mClient.setGroupOwner(groupID, owner, new IGeneralCallback2.Stub() {
                @Override
                public void onSuccess(String success) throws RemoteException {
                    callback.onSuccess(success);
                }
    ...
    public void addGroupManager(String groupID, List<String> memberIds, GeneralCallback2 callback){
        if (!checkRemoteService()) {
            return;
        }
        try {
            mClient.addGroupManager(groupID, memberIds, new IGeneralCallback2.Stub() {
                @Override
                public void onSuccess(String success) throws RemoteException {
                    mainHandler.post(()->{
                        callback.onSuccess(success);
    ...
    public void delGroupManager(String groupID, List<String> memberIds, GeneralCallback2 callback){
        if (!checkRemoteService()) {
            return;
        }
        try {
            mClient.delGroupManager(groupID, memberIds, new IGeneralCallback2.Stub() {
                @Override
                public void onSuccess(String success) throws RemoteException {
                    mainHandler.post(()-> {
                        callback.onSuccess(success);
    ...
    public void updateRedPaket(RedPacketInfo redPacketInfo){
        if(redPacketInfo == null){
            return;
        }
        try {
            mClient.updateRedPaket(redPacketInfo);
        }catch (Exception e){

        }
    }

    public void openRedPacket(String packetID, String unpackID, long messageID){
        if (!checkRemoteService()) {
            return;
        }
        try {
            mClient.openRedPacket(packetID, unpackID, messageID, new IGeneralCallback2.Stub() {
                @Override
                public void onSuccess(String success) throws RemoteException {
                }
    ...
    public void fetchRedPacket(String packetID, String unpackID, String user, GeneralCallback2 callback){
        if (!checkRemoteService()) {
            callback.onFail(ErrorCode.SERVICE_DIED);
            return;
        }
        try {
            mClient.fetchRedPacket(packetID, unpackID, user, new IGeneralCallback2.Stub() {
                @Override
                public void onSuccess(String success) throws RemoteException {
                    callback.onSuccess(success);
                }
    ...
    public List<UnpackInfo> getUnpackList(String unpackID){
        ...
        try {
            return mClient.getUnpackList(unpackID);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return unpackInfoList;
    ...
    public void sendCallMessage(Message msg, GeneralCallback callback){
        ...
        try {
            mClient.sendCallMessage(msg, new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if(callback != null) {
    ...
    public void recallMessage(final Message msg, final GeneralCallback callback) {
        try {
            mClient.recall2(msg.messageUid, new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
     ...
     * @param callback 删除回调
     */
    public void deleteMessageTo(final Message msg, final GeneralCallback callback) {
        try {

            mClient.deleteMessageTo(msg.messageUid, new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
             //       Message recallMsg = mClient.getMessage(msg.messageId);
                    mClient.deleteMessage(msg.messageId);
                    mainHandler.post(() -> {
                        if (callback != null) {
                            callback.onSuccess();
    ...
    public void sendNeedShare(List<String> userList, String groupName, String portrait, String groupId) {
        ...
        try {
            mClient.sendNeedShare(userList, groupName, portrait, groupId);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void sendBroadcast(final String content, final GeneralCallback callback) {
        if (!checkRemoteService()) {
            if (callback != null) {
                callback.onFail(ErrorCode.SERVICE_DIED);
            }
        ...
        try {
            ...
            json.put("type", "help");
            mClient.broadcast(Base64.encodeToString(json.toString().getBytes(), Base64.NO_WRAP), new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    mainHandler.post(new Runnable() {
                        @Override
    ...
    public void findObject(String text, GeneralCallback callback){
        if (!checkRemoteService()) {
            return;
        }
        try {
            mClient.findObject(text, new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(new Runnable() {
     ...
     */
    @NonNull
    public List<ConversationInfo> getConversationList(List<Conversation.ConversationType> conversationTypes, List<Integer> lines, int tagId) {
        if (!checkRemoteService()) {
        ...
        try {
            return mClient.getConversationList(intypes, inlines, tagId);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return new ArrayList<>();
    ...
    public void deleteFileRecord(long messageUid, final GeneralCallback callback) {
        ...
        try {
            mClient.deleteFileRecord(messageUid, new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(new Runnable() {
     ...
     * @return
     */
    public Message getMessageByUid(String msgHash0) {
        if (!checkRemoteService()) {
            return null;
        }

        try {
            return mClient.getMessageByUid(msgHash0);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public Message getMessageByHash(String msgHash) {
        if (!checkRemoteService()) {
            return null;
        }

        try {
            return mClient.getMessageByHash(msgHash);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public void saveCallMessage(Message message){
        ...
        try {
            mClient.saveCallMessage(message);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public void clearConversation(boolean clearMsg) {
        if (!checkRemoteService()) {
            return;
        }

        try {
            mClient.clearConversation(clearMsg);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public void removeConversation(Conversation conversation, boolean clearMsg) {
        ...
        try {
            mClient.clearMessages(0, conversation.target, 0);
    ...
    public String getGroupMemberDisplayName(String groupId, String memberId) {
        try {
            if (groupId != null) {
                ...
                if (groupInfo != null && groupInfo.showAlias != 0) {
                    GroupMember groupMember = getGroupMember(groupId, memberId);
                    if (groupMember.alias != null)
            ...
            if (userInfo == null) {
                getUserInfo(memberId, groupId, true);
                return "<" + getUserInfo(memberId, groupId, true) + ">";
            }
    ...
    public void handleGroupRequest(String userId, String groupId, boolean accept, final GeneralCallback callback) {
        if (!checkRemoteService()) {
            if (callback != null)
                callback.onFail(ErrorCode.SERVICE_DIED);
            return;
        ...
        try {
            mClient.handleGroupRequest(userId, groupId, accept, new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(new Runnable() {
    ...
    public void clearFriend(final GeneralCallback callback){
        if (!checkRemoteService()) {
            if (callback != null)
                callback.onFail(ErrorCode.SERVICE_DIED);
            return;
        ...
        try {
            mClient.clearFriend(new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(new Runnable() {
...
//    public void getGroupDetail(String groupId, String type, GeneralCallback2 callback){
//        if (!checkRemoteService()) {
//            return;
//        }
//        try {
//            mClient.getGroupDetail(groupId, type, new IGeneralCallback2.Stub() {
//                @Override
//                public void onSuccess(String success) throws RemoteException {
//                    callback.onSuccess(success);
//                }
...
//    }
    ...
    public GroupInfo getGroupInfoFromDB(String groupId) {
        ...
        try {
            return mClient.getGroupInfoFromDB(groupId);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return new NullGroupInfo(groupId);
    ...
    public boolean isGroupMember(String groupId, String userId){
        ...
        try {
            return mClient.isGroupMember(groupId, userId);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    public void uploadMediaFileToOss(String mediaPath, int mediaType, final UploadMediaCallback callback) {
        if (!checkRemoteService()) {
            if (callback != null)
                callback.onFail(ErrorCode.SERVICE_DIED);
            return;
    ...
    public void uploadLogger(final GeneralCallback2 callback) {
        if (!checkRemoteService()) {
            if (callback != null)
                callback.onFail(ErrorCode.SERVICE_DIED);
            return;
        ...
        try {
            mClient.uploadLogger(new IUploadMediaCallback.Stub() {
                @Override
                public void onSuccess(final String remoteUrl) throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(new Runnable() {
    ...
    public void modifyMyInfo(List<ModifyMyInfoEntry> values, final GeneralCallback callback) {
        if(userInfoCache != null && userInfoCache.size() > 0 && !TextUtils.isEmpty(userId)) {
    ...
    public boolean recallMessage2(Message message) {
        if (!checkRemoteService()) {
            return false;
        }
     ...
     * @param callback
     */
    public void createGroup(String groupId, String groupName, String groupPortrait,String owner2, GroupInfo.GroupType groupType, List<String> memberIds, List<Integer> lines, MessageContent notifyMsg, final GeneralCallback2 callback) {
        if (!checkRemoteService()) {
            if (callback != null)
                callback.onFail(ErrorCode.SERVICE_DIED);
            return;
        ...
        try {
            mClient.createGroup(groupId, groupName, groupPortrait,owner2, groupType.value(), memberIds, inlines, content2Payload(notifyMsg), new IGeneralCallback2.Stub() {
                @Override
                    ...
                    if (callback != null) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                userList.addAll(memberIds);
                                // 移除本机ID
                                //userList.remove();
                                try {
                                    mClient.sendNeedShare(memberIds, groupName, groupPortrait, result);
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                                ...
                                /*if (memberIds.size() != 0) {
                                    Message message = new Message();
                                    message.content = new CardMessageContent(CardType_Group, result, groupName, groupName, groupPortrait);
                                    message.conversation = new Conversation( 1, result);
                                    //message.
    ...
    public void joinGroup(String groupId, String reason, final GeneralCallback callback){
        if (!checkRemoteService()) {
            if (callback != null)
                callback.onFail(ErrorCode.SERVICE_DIED);
            return;
        ...
        try {
            mClient.joinGroup(groupId, reason, new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(new Runnable() {
    ...
    public void modifyGroupMemberAlias(String groupId, String memberId, String alias, List<Integer> lines, MessageContent notifyMsg, final GeneralCallback callback) {
        ...
        try {
            mClient.modifyGroupMemberAlias(groupId, memberId, alias, inlines, content2Payload(notifyMsg), new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(new Runnable() {
    ...
    public List<GroupMember> getGroupMemberAll(String groupId) {
        ...
        try {
            return mClient.getGroupMemberAll(groupId);
        } catch (RemoteException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public List<GroupMember> getGroupManagers(String groupId) {
        ...
        try {
            return mClient.getGroupManagers(groupId);
        } catch (RemoteException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public void getGroupMemberZone(String groupId, int start, int count, GetGroupMembersCallback callback) {
        if (!checkRemoteService()) {
            callback.onFail(-1);
            return;
        }
        try {
            mClient.getGroupMemberZone(groupId, start, count, new IGetGroupMemberCallback.Stub() {
                @Override
                public void onSuccess(List<GroupMember> members) throws RemoteException {
                    mainHandler.post(() -> callback.onSuccess(members));
                }

                @Override
                public void onFailure(int errorCode) throws RemoteException {
                    System.out.println("@@@ getGroupMemberZone failed.");
                    mainHandler.post(() -> callback.onFail(errorCode));
                }
            });
        } catch (RemoteException e) {
    ...
    public void getGroupMemberFromDB(String groupId, int begin, int end, GetGroupMembersCallback callback) {
        if (!checkRemoteService()) {
            callback.onFail(-1);
            return;
        }
        try {
            mClient.getGroupMemberFromDB(groupId, begin, end, new IGetGroupMemberCallback.Stub() {
                @Override
                public void onSuccess(List<GroupMember> members) throws RemoteException {
    ...
    public void clearOutGroupMembers(String groupId, int min) {
        ...
        try {
            mClient.clearOutGroupMembers(groupId, min);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void muteGroupMember(String groupId, boolean isSet, List<String> memberIds, List<Integer> lines, MessageContent notifyMsg, final GeneralCallback callback) {
        ...
        try {
            mClient.muteOrAllowGroupMember(groupId, isSet, 0, memberIds, false, inlines, content2Payload(notifyMsg), new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(() -> callback.onSuccess());
    ...
    public void allowGroupMember(String groupId, boolean isSet, List<String> memberIds, List<Integer> lines, MessageContent notifyMsg, final GeneralCallback callback) {
        ...
        try {
            mClient.muteOrAllowGroupMember(groupId, isSet, 0, memberIds, true, inlines, content2Payload(notifyMsg), new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(() -> callback.onSuccess());
    ...
    public void muteGroup(String groupId, boolean isSet, List<String> memberIds, List<Integer> lines, MessageContent notifyMsg, final GeneralCallback callback) {
        if (!checkRemoteService()) {
            if (callback != null)
                callback.onFail(ErrorCode.SERVICE_DIED);
            return;
        ...
        try {
            mClient.muteGroup(groupId, isSet, 1, memberIds, true, inlines, content2Payload(notifyMsg), new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(() -> callback.onSuccess());
    ...
    public List<LitappInfo> getCollectLitappList(){
        ...
        try {
            return mClient.getCollectLitappList();
        }
        catch (Exception e){
            e.printStackTrace();
        }
    ...
    public String getWallet(String walletId){
        ...
        try {
            //List<WalletsInfo>
            //return new ArrayList<>();
            return mClient.getWallets(walletId);
        }
        catch (Exception e){
            e.printStackTrace();
        }
    ...
    public void deleteCollectLitapp(String target){
        try {
            mClient.deleteCollectLitapp(target);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }

    public void insertWallets(String str) {
        try {
            System.out.println("@@@   insertWallets");
            mClient.insertWallets(str);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean insertTag(String name, int tagId) {
        try {
            ...
            return mClient.insertTag(name, tagId);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return false;
    ...
    public boolean insertTagUser(String osnId, int tagId){
        try {
            System.out.println("@@@   insertTagUser");
            return mClient.insertTagUser(osnId, tagId);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return false;
    ...
    public boolean updateTagUser(String osnId, int tagId){
        try {
            //System.out.println("@@@   insertTagUser");
            return mClient.updateTagUser(osnId, tagId);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return false;
    ...
    public boolean deleteTagUser(String osnId){
        try {
            //System.out.println("@@@   insertTagUser");
            return mClient.deleteTagUser(osnId);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return false;
    ...
    public boolean deleteTag(int tagId){
        try {
            //System.out.println("@@@   insertTagUser");
            return mClient.deleteTag(tagId);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return false;
    ...
    public List<String> listTagUser(int tagId){
        try {
            return mClient.listTagUser(tagId);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return new ArrayList<>();
    ...
    public String queryTagUser(String onsId){
        try {
            return mClient.QueryTagUser(onsId);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public void getLitappList(final GetLitappsCallback callback) {
        if (callback == null) {
            return;
        }
        if (!checkRemoteService()) {
        ...
        workHandler.post(() -> {
            List<LitappInfo> litapps = null;
            try {
                litapps = mClient.getLitappList();
            } catch (RemoteException e) {
                e.printStackTrace();
            }
            if(litapps == null)
                litapps = new ArrayList<>();
            List<LitappInfo> finalLitapps = litapps;
            mainHandler.post(() -> callback.onSuccess(finalLitapps));
        });
    }

    public void addCollectLitapp(LitappInfo litappInfo, GeneralCallback callback) {
        if (callback == null) {
            return;
        }
        if (!checkRemoteService()) {
        ...
        workHandler.post(() -> {
            try {
                mClient.addCollectLitapp(litappInfo);
                mainHandler.post(callback::onSuccess);
            } catch (RemoteException e) {
                e.printStackTrace();
                mainHandler.post(()->callback.onFail(-1));
    ...
    public void addLitapp(LitappInfo litappInfo, GeneralCallback callback) {
        if (callback == null) {
            return;
        }
        if (!checkRemoteService()) {
    ...
    public LitappInfo getCollectLitapp(String target) {
        if (!checkRemoteService())
            return null;
        try {
            return mClient.getCollectLitapp(target);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public LitappInfo getLitappInfo(String target, boolean refresh) {
        if (!checkRemoteService())
            return null;
        try {
            return mClient.getLitappInfo(target, refresh);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return null;
    }
    public void getLitappInfoEx(String target, boolean refresh, GetLitappInfoCallback callback) {
        if (!checkRemoteService()){
            if(callback != null)
                callback.onFail(-1);
        }
        try {
            mClient.getLitappInfoEx(target, refresh, new IGetLitappCallback() {
                @Override
                public void onSuccess(LitappInfo litapp) throws RemoteException {
                    mainHandler.post(()->{callback.onSuccess(litapp);});
                }
    ...
    public boolean verifyData(String osnID, byte[] data, String sign){
        if (!checkRemoteService())
            return false;
        try {
            return mClient.verifyData(osnID, data, sign);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return false;
    ...
    public String encryptData(String osnID, byte[] data){
        if (!checkRemoteService())
            return null;
        try {
            return mClient.encryptData(osnID, data);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public void setNoDisturbingTimes(int startMins, int endMins, final GeneralCallback callback) {
        ...
        try {
            mClient.setUserSetting(UserSettingScope.NoDisturbing, "", startMins + "|" + endMins, new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(() -> callback.onSuccess());
    ...
    public void clearNoDisturbingTimes(final GeneralCallback callback) {
        ...
        try {
            mClient.setUserSetting(UserSettingScope.NoDisturbing, "", "", new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(() -> callback.onSuccess());
    ...
    public void getAuthorizedMediaUrl(long messageUid, MessageContentMediaType mediaType, String mediaPath, final GeneralCallback2 callback) {
        ...
        try {
            mClient.getAuthorizedMediaUrl(messageUid, mediaType.getValue(), mediaPath, new IGeneralCallback2.Stub() {
                @Override
    ...
    public void getApplicationId(String applicationId, final GeneralCallback2 callback) {
        ...
        try {
            mClient.getApplicationId(applicationId, new IGeneralCallback2.Stub() {
                @Override
    ...
    public void sendConferenceRequest(long sessionId, String roomId, String request, String data, final GeneralCallback2 callback) {
        ...
        try {
            ...
            mClient.sendConferenceRequest(sessionId, roomId, request, data, new IGeneralCallback2.Stub() {
                @Override
    ...
    public MessageContent messageContentFromPayload(MessagePayload payload, String from) {
        ...
        try {
            ...
            Log.e(TAG, "decode message error, fallback to unknownMessageContent. " + payload.contentType);
            e.printStackTrace();
            if (content == null) {
                return null;
            }
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            try {
                ...
                mClient.setOnLitappInfoUpdateListener(new IOnLitappInfoUpdateListener.Stub() {
                    @Override
                    public void onLitappInfoUpdated(List<LitappInfo> litappInfos) throws RemoteException {
                        ChatManager.this.onLitappInfoUpdated(litappInfos);
                    }
                });
                mClient.setOnLitappInfoResultListener(new IOnLitappInfoResultListener.Stub() {
                    @Override
                    public void onLitappInfoResult(List<LitappInfo> litappInfos) throws RemoteException {
                        ChatManager.this.onLitappInfoResult(litappInfos);
                    }
                });
                ...
                System.out.println("re connect null null");
                mClient.connect(null, null);
    ...
    private void registerCoreMessageContents() {
        registerMessageContent(GroupNotifyContent.class);
