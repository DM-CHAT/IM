...
public class VideoMessageContent extends MediaMessageContent {
    ...
    public VideoMessageContent() {
        ...
        this.messageType = MessageContentMediaType.VIDEO;
    }
    ...
    public MessagePayload encode() {
        ...
        //payload.searchableContent = activity.getString(R.string.video_digest);
...
//              thumbnail = ThumbnailUtils.extractThumbnail(thumbnail, 320, 240, ThumbnailUtils.OPTIONS_RECYCLE_INPUT);
    ...
    public String digest(Message message, Context context) {
        return context.getString(R.string.video_digest);
    }
