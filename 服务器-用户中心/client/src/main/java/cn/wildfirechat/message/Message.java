...
import static cn.wildfirechat.message.core.MessageDirection.Send;
...
public class Message implements Parcelable {
    ...
    public String digest(Activity activity) {
        return content.digest(this, activity);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.messageJson);
    ...
    protected Message(Parcel in) {
        ...
        this.messageJson = in.readString();
    ...
    public boolean equals(Object o) {
        ...
        //if(!fileName.equals(message.fileName)) return false;
