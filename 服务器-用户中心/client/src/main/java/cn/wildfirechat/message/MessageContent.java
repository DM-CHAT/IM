...
public abstract class MessageContent implements Parcelable {
    ...
    //public abstract String digest(Message message, Activity activity);
    public abstract String digest(Message message, Context context);

    //0 普通消息, 1 部分提醒, 2 提醒全部
    public int mentionedType;

    public MessageContentMediaType messageType;
