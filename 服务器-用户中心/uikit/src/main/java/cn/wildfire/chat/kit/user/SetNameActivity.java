...
public class SetNameActivity extends WfcBaseActivity {
    ...
    private void changeAlias() {
        ...
        if (TextUtils.isEmpty(displayName)) {
            Toast.makeText(this, R.string.id_is_empty, Toast.LENGTH_SHORT).show();
            return;
        }
        WfcUIKit.getWfcUIKit().getAppServiceProvider().changeName(displayName, new SimpleCallback<Void>() {
            ...
            public void onUiSuccess(Void aVoid) {
                ...
                Toast.makeText(SetNameActivity.this, R.string.modify_success, Toast.LENGTH_SHORT).show();
                finish();
            }

            @Override
            public void onUiFailure(int code, String msg) {
                Toast.makeText(SetNameActivity.this, getString(R.string.set_account_failed) + code + " " + msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
}
