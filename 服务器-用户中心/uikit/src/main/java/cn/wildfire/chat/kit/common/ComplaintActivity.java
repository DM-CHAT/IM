...
//        );
    ...
    protected void onClick(View view) {
        ...
        if (TextUtils.isEmpty(complaintContent)) {
            Toast.makeText(this, getString(R.string.input_empty), Toast.LENGTH_SHORT);
            return;
        }
        ...
        new Handler(getMainLooper()).postDelayed(() -> {
            alertDialog.dismiss();
            Toast.makeText(ComplaintActivity.this, getString(R.string.submit_success), Toast.LENGTH_SHORT).show();
            finish();
        }, 1000);
    }
