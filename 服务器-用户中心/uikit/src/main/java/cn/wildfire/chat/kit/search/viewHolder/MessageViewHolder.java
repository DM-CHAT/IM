...
public class MessageViewHolder extends RecyclerView.ViewHolder {
    ...
    public void onBind(Message message) {
        ...
        if (message.content instanceof NotificationMessageContent) {
            contentTextView.setText(((NotificationMessageContent) message.content).formatNotification(message, WfcUIKit.getActivity()));
        } else {
            contentTextView.setText(message.digest(WfcUIKit.getActivity()));
        }
