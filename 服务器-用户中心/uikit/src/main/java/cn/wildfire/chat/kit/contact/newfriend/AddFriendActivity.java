...
public class AddFriendActivity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        btn_addTarget = findViewById(R.id.btn_addTarget);
        ...
        btn_addTarget.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String osnID = edt_content.getText().toString().trim();
                if(osnID.isEmpty()){
                    Toast.makeText(AddFriendActivity.this,getString(R.string.input_empty),Toast.LENGTH_SHORT).show();
                    return;
                }
                if(osnID.startsWith("OSN")){
                    if(osnID.startsWith("OSNU")){
                        ...
                        Intent intent = new Intent(AddFriendActivity.this, GroupInfoActivity.class);
                        ...
                        ChatManager.Instance().getLitappInfoEx(osnID, false, new GetLitappInfoCallback() {
                            ...
                            public void onSuccess(LitappInfo litappInfo) {
                                Intent intent = new Intent(AddFriendActivity.this, LitappInfoActivity.class);
                            ...
                            public void onFail(int errorCode) {
                                Toast.makeText(AddFriendActivity.this, getString(R.string.add_failure), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    else{
                        Toast.makeText(AddFriendActivity.this, getString(R.string.error_osnid), Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    //从服务器获取osnID
                    ...
                    String PREFIX = (String) SPUtils.get(AddFriendActivity.this,"PREFIX",null);
                    if(PREFIX == null){
                        Toast.makeText(AddFriendActivity.this,getString(R.string.error_osnid),Toast.LENGTH_SHORT).show();
                        return;
                    }
                        ...
                        public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                            ...
                            if(addOsnIDInfo.getCode() == 200){
                                ...
                                AddFriendActivity.this.runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(AddFriendActivity.this,addOsnIDInfo.getMsg(),Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                                });
                            }
