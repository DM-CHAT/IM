...
public class LitappListAdapter extends RecyclerView.Adapter<LitappViewHolder> {
    ...
    private OnLitappLongCLickListener onLitappLongCLickListener;
    ...
    public void setOnLitappItemLongClickListener(OnLitappLongCLickListener onLitappItemLongClickListener){
        this.onLitappLongCLickListener = onLitappItemLongClickListener;
    }
    ...
    public LitappViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view.findViewById(R.id.contactLinearLayout).setOnLongClickListener(view1 -> {
    ...
    public interface OnLitappLongCLickListener{
        void onLitappLongClick(LitappInfo litappInfo);
    }
}
