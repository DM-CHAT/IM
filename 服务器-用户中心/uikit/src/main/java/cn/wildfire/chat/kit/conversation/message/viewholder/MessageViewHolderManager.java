...
public class MessageViewHolderManager {
    ...
    private void init() {
        ...
        registerMessageViewHolder(CallMessageViewHolder.class, R.layout.conversation_item_voip_send, R.layout.conversation_item_voip_receive);
        ...
        registerMessageViewHolder(RedPacketMessageContentViewHolder.class, R.layout.conversation_item_red_packet_send, R.layout.conversation_item_red_packet_receive);
    }
