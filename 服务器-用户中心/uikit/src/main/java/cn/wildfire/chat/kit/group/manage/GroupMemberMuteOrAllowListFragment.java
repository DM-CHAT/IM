...
public class GroupMemberMuteOrAllowListFragment extends BaseUserListFragment {
    ...
    public void onUserClick(UIUserInfo userInfo) {
        ...
        if(me.type == GroupMember.GroupMemberType.Manager || me.type == GroupMember.GroupMemberType.Owner){
            new MaterialDialog.Builder(getActivity())
                    .items(Collections.singleton(groupMuted ? getString(R.string.remove_white_list) : getString(R.string.clean_mute)))
