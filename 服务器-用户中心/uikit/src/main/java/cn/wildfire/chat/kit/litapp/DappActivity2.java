...
public class DappActivity2 extends WfcBaseActivity {
    WebView mWebView;
    boolean isLogin = false;
    LitappInfo litappInfo;
    private ValueCallback<Uri[]> uploadMessageAboveL;
    String TAG = DappActivity2.class.getSimpleName();
    ...
    protected void afterViews() {
        ...
        System.out.println("@@@@  getParcelableExtra urlParam =" + litappInfo.urlParam);
        ...
        iv_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PopupMenu popupMenu = new PopupMenu(DappActivity2.this, iv_share);
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        ...
                        if (itemId == R.id.clear_cache) {
                            ...
                            if (litappInfo != null) {
                                ...
                                startActivity(QRCodeActivity.buildQRCodeIntent(DappActivity2.this, WfcUIKit.getString(R.string.qrcode), litappInfo.portrait, qrCodeValue, litappInfo.target));
                            }
                            ...
                            if (litappInfo != null) {
                                ...
                                Intent intent = new Intent(DappActivity2.this, ForwardActivity.class);
...
/*
                                ...
                                Intent intent = new Intent(DappActivity2.this, ContactListActivity.class);
...
*/
        ...
        mWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public View getVideoLoadingProgressView() {
                FrameLayout frameLayout = new FrameLayout(DappActivity2.this);
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                if (checkLitapp()) {
                    ...
                    //System.out.println("@@@@ DappActivity2 urlParam : " + this.litappInfo.urlParam);
                    ...
                    System.out.println("@@@@ DappActivity2 open dapp url : " + url);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == FILE_CHOOSER_RESULT_CODE) {
            ...
            if (globalCallback != null) {
                DappActivity2.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
            ...
            // 支付完成，返回给小程序
            String payResult = data.getParcelableExtra("payResult");
    ...
    private void showCustomView(View view, WebChromeClient.CustomViewCallback callback) {
        ...
        DappActivity2.this.getWindow().getDecorView();

        FrameLayout decor = (FrameLayout) getWindow().getDecorView();
        fullscreenContainer = new FullscreenHolder(DappActivity2.this);
    ...
    JSONObject runJsCommand(JSONObject json, String callback) {
        ...
        System.out.println("@@@     Dapp     dapp command : " + json.getString("command"));
        try {
            switch (json.getString("command")) {
                ...
                case "AddWallet":
                    ...
                    Intent intent2 = new Intent(DappActivity2.this, AddSqliteActivity.class);
                ...
                case "Share":
                    ...
                    if (dappJson2 != null) {
                        ...
                        Intent intent6 = new Intent(DappActivity2.this, ContactListActivity.class);
                    ...
                    if (dappJson2 != null) {
                        ...
                        Intent intent6 = new Intent(DappActivity2.this, ForwardActivity.class);
                ...
                case "TransactionResult":
                    ...
                    System.out.println("@@@   TransactionResult=" + json);
                ...
                case "OrderPayment":
                    ...
                    System.out.println("@@@@ data:" + payData);
                    ...
                    if (checkOrderPaymentParam(payData, litappInfo.target)) {
                        ...
                        if (walletInfo != null) {
                            ...
                            try {
                                ...
                                //System.out.println("@@@@ urlParam : " + urlParamJson);

                                Intent intent5 = new Intent(DappActivity2.this, LitappActivity.class);
                ...
                case "OrderPaymentResult":
                    ...
                    System.out.println("@@@   OrderPaymentResult=" + result1);
                    Intent intent6 = new Intent();
                    intent6.putExtra("payResult", result1);
                    setResult(301, intent6);
                    finish();
                ...
                case "OpenDapp":
                    try {
                        ...
                        Intent intent4 = new Intent(DappActivity2.this, LitappActivity.class);
                ...
                case "AddObj":
                    Intent intent4 = new Intent(DappActivity2.this, ContactListActivity.class);
                ...
                case "SetNft":
                    AlertDialog.Builder dialog2 = new AlertDialog.Builder(DappActivity2.this);
                    dialog2.setMessage("是否同意将该NFT设置为头像");
                    dialog2.setCancelable(false);
                    dialog2.setPositiveButton(getString(R.string.confirm), new DialogInterface.OnClickListener() {
                        @Override
                                            ...
                                            public void onSuccess() {
                                                ChatManager.Instance().upDescribes("nft", url2, null, new GeneralCallback2() {
                                                    ...
                                                    public void onSuccess(String result) {
                                                        Toast.makeText(DappActivity2.this, getString(R.string.set_ok), Toast.LENGTH_SHORT).show();
                                                    }

                                                    @Override
                                                    public void onFail(int errorCode) {
                                                        Toast.makeText(DappActivity2.this, getString(R.string.operation_failure), Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                            }
    ...
    private void orderPaymentWeb(JSONObject json) {
        ...
        Intent intent = new Intent(DappActivity2.this, LitappActivity.class);
    ...
    private JSONObject paySign(JSONObject json2, String dappId) {
        ...
        View views = View.inflate(DappActivity2.this, R.layout.dialog_show_info, null);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DappActivity2.this);
        ...
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (needShadowSign.equalsIgnoreCase("yes")) {
                    View views2 = View.inflate(DappActivity2.this, R.layout.dialog_keyword2, null);
                    ...
                    AlertDialog.Builder builder2 = new AlertDialog.Builder(DappActivity2.this);
                    ...
                    btn_confirm2.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (needPayPassword.equalsIgnoreCase("yes")) {
                                ...
                                View views1 = View.inflate(DappActivity2.this, R.layout.dialog_keyword3, null);
                                ...
                                AlertDialog.Builder builder1 = new AlertDialog.Builder(DappActivity2.this);
