...
public class CompositeMessageContentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class MessageContentViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Message message, int position) {
            ...
            if (content instanceof ImageMessageContent) {
                ...
                videoDurationTextView.setText(WfcUIKit.getString(R.string.unknown_duration));
                ...
                for (int i = 0; i < messages.size() && i < 4; i++) {
                    ...
                    sb.append(u.displayName + ": " + m.content.digest(m, WfcUIKit.getActivity()));
                    sb.append("\n");
                }
                ...
                contentTextView.setText(content.digest(msg, WfcUIKit.getActivity()));
            }
        }
    }
    ...
    static class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Message message) {
            ...
            String pattern = WfcUIKit.getString(R.string.time_p0);
            compositeDurationTextView.setText(startDate.toString(pattern) + WfcUIKit.getString(R.string.to) + endDate.toString(pattern));
        }
    }
