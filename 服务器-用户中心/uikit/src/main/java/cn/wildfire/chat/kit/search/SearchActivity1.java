...
import cn.wildfire.chat.kit.widget.SearchView1;
import cn.wildfirechat.remote.ChatManager;

/**
 * 如果启动{@link android.content.Intent}里面包含keyword，直接开始搜索
 */
public abstract class SearchActivity1 extends WfcBaseNoToolbarActivity {
    ...
    public void onCancelClick() {
        finish();
        /*if(!TextUtils.isEmpty(searchView.toString())){
    ...
    protected int contentLayout() {
        return R.layout.search_portal_activity1;
    }
