...
public class UpdateManager extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if(intent.getAction().equals(DownloadManager.ACTION_DOWNLOAD_COMPLETE)){
            ...
            if(downloadID == mDowloadID){
                ...
                if(apkFile == null){
                    Toast.makeText(context, "download apk file is null", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                    ...
                    Uri contentUri = FileProvider.getUriForFile(context,  "com.mhhy.jtalking10.fileProvider", apkFile);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public void startUpdate(Context context, String url){
        ...
        request.setTitle(WfcUIKit.getString(R.string.downloading) + appName);
