...
import cn.wildfire.chat.kit.group.GroupListActivity1;
...
public class ContactListFragment1 extends BaseUserListFragment implements QuickIndexBar.OnLetterUpdateListener {
    ...
    private void showGroupList() {
        Intent intent = new Intent(getActivity(), GroupListActivity1.class);
        if (forward){
