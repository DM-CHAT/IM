...
public class GroupManagerListFragment extends BaseUserListFragment {
    ...
    public void initFooterViewHolders() {
        System.out.println("@@@     GroupMember.Owner="+groupMember.memberId);
        System.out.println("@@@     groupInfo.Owner="+groupInfo.owner);
        if (groupMember.memberId.equalsIgnoreCase(groupInfo.owner)) {
            System.out.println("@@@     显示添加群管理员");
    ...
    public void onUserClick(UIUserInfo userInfo) {
        ...
        if (me.memberId.equalsIgnoreCase(groupInfo.owner)) {
            new MaterialDialog.Builder(getActivity())
                .items(Collections.singleton(getString(R.string.remove_admin)))
