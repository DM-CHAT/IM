...
public class GroupListActivity1 extends WfcBaseActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GroupListActivity1.this, CreateConversationActivity.class);
    ...
    protected void afterViews() {
        if(pick){
            ...
            GroupListFragment1 fragment = new GroupListFragment1();
