...
public class OssHelper {
     ...
     * @return 外网访问的路径
     */
    public String uploadImage(Context context,String path,String pathName,String filePath) {
        ...
        try {
            ...
            String remoteUrl = oss.presignPublicObjectURL(BUCKETNAME, filePath + objectKey);
            return remoteUrl;
    ...
    public void uploadFileDeleteTempFile(String path, String childDir, CallBack callBack) {
        //String objectKey = FileUtils.getFileNameFromPath(path);
        Random random = new Random();
        int number = random.nextInt(899999);
        number = number + 100000;
     ...
     */
    public static String setImageBackground(String filename) {
        ...
        oss.asyncGetObject(get, new OSSCompletedCallback<GetObjectRequest, GetObjectResult>() {
            ...
            public void onSuccess(GetObjectRequest request, GetObjectResult result) {
                ...
                if (length > 0) {
                    ...
                    // 下载保存位置
                    path[0] = UIUtils.getContext().getCacheDir().getAbsolutePath()+ "/" + filename;

                    try {
                        FileOutputStream fout = new FileOutputStream(path[0]);
                        fout.write(buffer);
                        fout.close();
