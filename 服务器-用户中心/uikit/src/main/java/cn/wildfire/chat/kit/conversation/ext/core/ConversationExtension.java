...
public class ConversationExtension {
    ...
    private static ConversationExtension instance;

    private ConversationExtension(Context context) {
        this.context = context;
    }

    public static synchronized ConversationExtension getInstance() {
        if (instance == null) {
            instance = new ConversationExtension(context);
        }
        return instance;
    }
