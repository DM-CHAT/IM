...
public class OsnMemberInfo {
    ...
    public static OsnMemberInfo toMemberInfo(JSONObject json){
        ...
        if(memberInfo.groupID == null)
            memberInfo.groupID = json.getString("receive_from");
        ...
        memberInfo.status = json.getIntValue("mute");
        return memberInfo;
    }
    public static List<OsnMemberInfo> toMemberInfos(JSONObject json){
        ...
        if(array != null) {
            for (Object o : array) {
                ...
                data.put("groupID", json.getString("receive_from"));
