...
//
//            NSString *path = [DMCCUtilities getDocumentPathWithComponent:[NSString stringWithUTF8String:info.username.c_str()]];
...
//
//    
//    info.clientid = [[[DMCCNetworkService sharedInstance] getClientId] UTF8String];
