...
#ifndef DMCCNetworkService_h
#define DMCCNetworkService_h
...
//群组成员增减更新通知
extern NSString *kGroupMemberAddOrLessUpdated;
//用户信息更新通知
...
//删除对方消息更新通知
extern NSString *kDeleteMsgInfoUpdated;
//撤回消息更新通知
extern NSString *kRecallMsgInfoUpdated;
//退出更新通知
extern NSString *kLoginOutKikoffUpdated;
 ...
 */
- (BOOL)onReceiveMessage:(DMCCMessage *)message;
@end
...
@interface RecvMessageReturnInfo : NSObject

@property (nonatomic, strong) NSMutableArray *messages;
@property (nonatomic, strong) NSMutableArray *nLists;
...
/**
 连接服务
 */
@interface DMCCNetworkService : NSObject
...
@property(nonatomic, weak) OsnSDK* osnsdk;
