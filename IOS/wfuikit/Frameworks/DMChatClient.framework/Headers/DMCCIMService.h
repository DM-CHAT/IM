...
#import "DMCCGroupInfo.h"
#import "DMCCConversationInfo.h"
#import "DMCCUserInfo.h"
#import "DMCCLitappInfo.h"
#import "DMCCFriendRequest.h"
#import "DMCCConversationSearchInfo.h"
#import "DMCCGroupMember.h"
#import "DMCCGroupSearchInfo.h"
#import "DMCCChatroomInfo.h"
#import "DMCCChatroomMemberInfo.h"
#import "DMCCUnreadCount.h"
#import "DMCCChannelInfo.h"
#import "DMCCPCOnlineInfo.h"
#import "DMCCFileRecord.h"
#import "DMCCFriend.h"
#import "DMCCTagInfo.h"
#import "DMCCRedPacketInfo.h"
#import "DMCCUnpackInfo.h"
#import "DMCCWalletInfo.h"
#import "DMCCCollectInfo.h"
...
typedef NS_ENUM(NSInteger, ModifyGroupInfoType) {
    ...
    Modify_Group_Type = 9,
    Modify_Group_PassType = 10,
    Modify_Group_BillBord = 11
};
...
typedef NS_ENUM(NSInteger, UserSettingScope) {
    ...
    UserSettingScope_allowAddFriend = 22,
    UserSettingScope_Mute_Group = 23,
    UserSettingScope_TimeInterval = 24,
    UserSettingScope_Forward = 25,
    UserSettingScope_Copy = 26,
    UserSettingScope_Clear = 27,
    UserSettingScope_GroupJoinType = 28,
    UserSettingScope_GroupJoinPwd = 29,
 ...
 */
typedef NS_ENUM(NSInteger, DMCCSearchUserType) {
...
typedef NS_ENUM(NSInteger, DMCCPlatformType) {
 ...
 * 对于群组建议使用我们的托管。
 */
@protocol DMCCUserSource <NSObject>
- (DMCCUserInfo *)getUserInfo:(NSString *)userId
...
/**
 IM服务
 */
@interface DMCCIMService : NSObject
...
@property(nonatomic, strong)OsnSDK* osnsdk;


@property(nonatomic, weak)id<DMCCUserSource> userSource;
...
/**
 ...
 @return 会话信息
 */
- (NSArray<DMCCConversationInfo *> *)getConversationInfos:(NSArray<NSNumber *> *)conversationTypes
 ...
 */
- (void)removeConversation:(DMCCConversation *)conversation
...
/**
 ...
 @return 未读数
 */
- (DMCCUnreadCount *)getUnreadCount:(NSArray<NSNumber *> *)conversationTypes
                       lines:(NSArray<NSNumber *> *)lines;
...
/**
 ...
 @param conversation 会话
 @param messageStatus 消息状态DMCCMessageStatus
 @param fromIndex 起始index
 @param count 总数
 @return 消息实体
 */
...
/**
 ...
 @return 好友请求
 */
- (DMCCFriendRequest *)getFriendRequest:(NSString *)uerId direction:(int)direction;
...
/**
 ...
 @return 群信息
 */
- (DMCCGroupInfo *)getGroupInfo:(NSString *)groupId
                        refresh:(BOOL)refresh;
...
/**
 ...
 个体禁言：
     mode=0 mute = 1 list=个体id号
 取消个体禁言：
    mode=0 mute = 0 list=个体id号
