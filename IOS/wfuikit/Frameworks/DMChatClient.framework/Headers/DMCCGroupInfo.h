 ...
 */
typedef NS_ENUM(NSInteger, DMCCGroupType) {
    GroupType_Normal = 0,
    GroupType_Free = 1,
...
/**
 群信息
 */
@interface DMCCGroupInfo : NSObject

/**
 群类型
 */
@property (nonatomic, assign)DMCCGroupType type;
...
@property (nonatomic, assign)int singleMute;
@property (nonatomic, assign)int fav;
@property (nonatomic, assign)int showAlias;
/**
 加群申请状态，0 不限制加入（用户可以自己加群或被普通群成员拉入）；1 普通群成员可以拉人进群；2 只有群管理才能拉人
 */
@property (nonatomic, assign)int joinType;
@property (nonatomic, assign)int passType;
@property (nonatomic, assign)int redPacket;
@property (nonatomic, assign)NSInteger tagID;
@property (nonatomic, assign)NSInteger ugID;
