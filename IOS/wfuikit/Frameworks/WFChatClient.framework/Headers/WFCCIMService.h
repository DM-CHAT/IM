...
/**
 ...
 @discuss 服务器不检查可撤回时间，应用逻辑来处理。
 */
- (void)DeleteToFromMessage:(WFCCMessage *)message
                    toUsers:(NSString *)toUser
       success:(void(^)(void))successBlock
         error:(void(^)(int error_code))errorBlock;
...
- (NSArray<WFCCGroupMember *> *)getGroupZoneMembers:(NSString *)groupId
                                              begin:(int)begin
                                        forceUpdate:(BOOL)forceUpdate;
/**
 根据成员类型获取群成员信息
...
- (WFCCUserInfo*) toClientUser:(OsnUserInfo*) userInfo;
- (WFCCGroupInfo*) toClientGroup:(OsnGroupInfo*) groupInfo;
- (WFCCGroupMember*) toClientMember:(OsnMemberInfo*) memberInfo;
- (NSArray<WFCCGroupMember*>*) updateMember:(NSString*) groupID members:(NSArray<OsnMemberInfo*>*) memberList;
- (NSString*) getUserID;
...
- (WFCCRedPacketInfo*) getRedPacket:(NSString*) packetID;
...
- (NSArray<WFCCUnpackInfo*>*) getUnpackList:(NSString*) unpackID;
...
- (NSArray<WFCCLitappInfo*>*) getLitAppList;
- (void)saveLitappWithInfo:(WFCCLitappInfo *)info;
- (void) delGroup:(NSString*) groupID;
- (WFCCLitappInfo *) getLitappInfoWithTarget:(NSString*) target
               refresh:(bool) refresh
                success:(void(^)(WFCCLitappInfo*))successBlock
                  error:(void(^)(int error_code))errorBlock;
- (void)loginLitappWithInfo:(WFCCLitappInfo *)info
           url:(NSString *)url
