...
@interface ZoloWalletViewController () <WKScriptMessageHandler>
...
@implementation ZoloWalletViewController
...
- (void)viewDidLoad {
    ...
    _url = [_url stringByAppendingFormat:@"language=%@&token=%@",language,token];
