...
- (void)setText:(NSString *)text isRight:(BOOL)isRight {
    _isRight = isRight;
    [self setText:text];
}
...
-(NSMutableAttributedString*)subStr:(NSString *)string {
    ...
    NSString *regulaStr = @"((https|http|ftp|rtsp|mms):\\/\\/)[^\\s]+([a-zA-z0-9])|(([0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}))(:[0-9]{1,4})*(/[a-zA-Z0-9\&%_\./-~-]*)?|((http|ftp|https)://[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z]{2,4})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)|(www.[a-zA-Z0-9\\.\\-]+[\\.|\\/]([a-zA-Z]{1,4})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)";
    ...
    NSDictionary *attributedDict = @{
                                         ...
                                         NSForegroundColorAttributeName:self.isRight ? MHColorFromHex(0x004988) : MHColor(93, 113, 144),
